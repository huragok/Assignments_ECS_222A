    ...
    \begin{homeworkProblem}
        ...
        \begin{homeworkSection}{\homeworkProblemName(d)}
            ...
            \problemAnswer{
                ...
                The results are shown in Table~\ref{table:4d}
                \begin{table}[!h]
                    \renewcommand{\arraystretch}{1.3}
                    %\caption{}
                    \label{table:4d}
                    ...
                    \begin{tabular}{cc|cc}
                        \hline
                         beginning of the string  & end of the string & min. \#
                        1's in the middle & max. ratio of contacts to 1's \\
                        \hline
                        1 with 4 neighbor 1's & 1 with 4 neighbor 1's & 6 &
                        $\frac{6\cdot 2+2\cdot 3}{2\cdot(6 + 2)} =\frac{9}{8} $
                        \\
                        1 with 4 neighbor 1's & 1 with 3 neighbor 1's & 5 &
                        $\frac{5\cdot 2+2\cdot 3}{2\cdot(5 + 2)} = \frac{8}{7}$
                        \\
                        1 with 4 neighbor 1's & 1 with 2 neighbor 1's & 4 &
                        $\frac{4\cdot 2+3 + 2}{2\cdot(4+2)} = \frac{13}{12}$
                        \\
                        1 with 4 neighbor 1's & 1 with 1 neighbor 1's & 3 &
                        $\frac{3\cdot 2+ 3 + 1}{2\cdot(3+2)} = 1$
                        \\
                        1 with 4 neighbor 1's & 1 with 0 neighbor 1's & 4 &
                        $\frac{4\cdot 2+ 3 + 0}{2\cdot(4+2)} = \frac{11}{12}$
                        \\
                        1 with 4 neighbor 1's & 0 & 4 & $\frac{4\cdot 2+1\cdot
                        3}{2\cdot(4+1)} = \frac{11}{10}$ \\
                        1 with 3 neighbor 1's & 1 with 3 neighbor 1's & 4 &
                        $\frac{4\cdot 2+2\cdot 3}{2\cdot(4+2)} = \frac{7}{6}$
                        \\
                        1 with 3 neighbor 1's & 1 with 2 neighbor 1's & 3 &
                        $\frac{3\cdot 2+3+2}{2\cdot(3+2)} = \frac{11}{10}$
                        \\
                        1 with 3 neighbor 1's & 1 with 1 neighbor 1's & 2 &
                        $\frac{2\cdot 2+3+1}{2\cdot(2+2)} = 1$
                        \\
                        1 with 3 neighbor 1's & 1 with 0 neighbor 1's & 3 &
                        $\frac{3\cdot 2+3+0}{2\cdot(3+2)} = \frac{9}{10}$ \\
                        1 with 3 neighbor 1's & 0 & 3 & $\frac{3\cdot 2+1\cdot
                        3}{2\cdot(3+1)} = \frac{9}{8}$ \\
                        \hline
                    \end{tabular}
                \end{table}
            }
