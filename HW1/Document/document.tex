    ...
    \begin{homeworkProblem}
        ...
        \begin{homeworkSection}{\homeworkProblemName(d)}
            ...
            \problemAnswer{
                ...
                to make the average number of contacts each 1 can form larger,
                since each of them can form at most 2 contacts. According to the
                number of neighboring 1's that the beginning and ending 1's
                have, we can count the minimum number of middle 1's in the
                string and therefore compute the maximum possible ratio of
                contacts to 1's. The results are
                shown in Table~\ref{table:4d} \begin{table}[!h]
                    \renewcommand{\arraystretch}{1.3}
                    %\caption{}
                    \label{table:4d}
                    \centering
                    \begin{tabular}{cc|cc}
                        ...
                        $\frac{6\cdot 2+2\cdot 3}{6 + 2} = $
                        \\
                        1 with 4 neighbor 1's & 1 with 3 neighbor 1's & 5 &
                        $\frac{5\cdot 2+2\cdot 3}{5 + 2} = $ \\
