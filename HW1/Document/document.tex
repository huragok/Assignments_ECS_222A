...
\begin{document}
    ...
    \begin{homeworkProblem}
        ...
        \begin{homeworkSection}{\homeworkProblemName(e)}
            ...
            \problemAnswer{
                Comparing the results from 2(a) and 2(c) we can see that the
                algorithm does not result in the minimun $D(S_1, S_2)$ in this
                case. Obviously it does not always solves the MinDistRem
                problem.
             }
        \end{homeworkSection}
    \end{homeworkProblem}
